...
public class LockScreenActivity extends SherlockActivity implements ICacheWordSubscriber {
	...
	private void showInequalityError() {
		Toast.makeText(LockScreenActivity.this, R.string.lock_screen_passphrases_not_matching, Toast.LENGTH_SHORT)
				.show();
		clearNewFields();
	}
	...
	public class TwoViewSlider {
		...
		public TwoViewSlider(ViewFlipper flipper, LinearLayout container1, LinearLayout container2, View view1,
				View view2) {
